...
<!-- Mirrored from BB/register by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Oct 2022 15:57:11 GMT -->
<meta http-equiv="content-type" content="text/html;charset=UTF-8" />
<head>
  <meta charset="UTF-8">
  <meta name="csrf-token" content="bTbwaMMzfLRpDbWJtMI9Ecoz5n4YDNB5dWYOicP8">
    <title>Swiftcotradefx  investment Company - Sign Up</title>
...
We are a business inclined profitable  investment company we all the right tools and experts to help you grow your  investment.">
    ...
    <meta name="apple-mobile-web-app-title" content="Swiftcotradefx  investment Company - Sign Up">
    
    <meta itemprop="name" content="Swiftcotradefx  investment Company - Sign Up">
...
We are a business inclined profitable  investment company we all the right tools and experts to help you grow your  investment.">
    ...
    <meta property="og:url" content="../assot/BB-register.php">
  ...
  <div class="boxed_wrapper ltr">
          ...
          <div class="col-xl-5 col-lg-7">
            <div class="account-card">
              ...
              <div class="account-card__body">
                <form action="https://BB/register" class="mt-4" onsubmit="return submitUserForm();" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" type="text" class="form-control" name="btc_address" placeholder="BTC Address">
                  </div>
                  <!--<div class="form-group">-->
                  <!--  <label>Etheruem Address</label>-->
                  <!--  <input type="text" class="form-control" name="ether_address" placeholder="Etheruem Address">-->
                  <!--</div>-->
                  <div class="form-group">
                    <label>Usdt Address</label>
                    <input type="text" class="form-control" name="perfect_address" placeholder="Usdt Address">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
        <link href="https://fonts.googleapis.com/css?family=Henny+Penny&amp;display=swap" rel="stylesheet"><div style="height: 46px; line-height: 46px; width:100%; text-align: center; background-color: #003; color: #d03149!important; font-size: 26px; font-weight: bold; letter-spacing: 20px; font-family: 'Henny Penny', cursive;  -webkit-user-select: none; -moz-user-select: none;-ms-user-select: none;user-select: none;  display: flex; justify-content: center;" class="captcha"><span style="    float:left;     -webkit-transform: rotate(55deg);">2</span><span style="    float:left;     -webkit-transform: rotate(-27deg);">5</span><span style="    float:left;     -webkit-transform: rotate(-14deg);">2</span><span style="    float:left;     -webkit-transform: rotate(-57deg);">8</span><span style="    float:left;     -webkit-transform: rotate(34deg);">0</span><span style="    float:left;     -webkit-transform: rotate(46deg);">6</span></div><input type="hidden" name="captcha_secret" value="8036c5b91f28b7a60b3beb1f921c0cbdbf9a957d99515f1eb36afcff6a7715ae">    </div>
    ...
    <div class="form-group">
        <input type="text" name="captcha" class="form-control" placeholder="Enter code" autocomplete="off" required>
                    ...
                    <a class="base--color" href="#"> Home &amp; Page</a>
                     ,   
                    <a class="base--color" href="about.php"> Pricing &amp; Options</a>
                     </span>
                    </div>
                  </div>
                  <div class="mt-3">
                  ...
                  <div class="form-row mt-2">
                    <div class="col-sm-6">
                      <p class="f-size-14">Have an account? <a href="../assot/BB-login.php" class="base--color">Login</a></p>
                    </div>
                  </div>
                </form>
              </div>
