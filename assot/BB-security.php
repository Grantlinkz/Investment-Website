...
<div class="area">
	<div class="bodycontainer">
		<h1 class="tlt text-white" style="margin: 20px 0;">An OTP Code <span class="text-default">has been sent to your email</span></h1>
		<div class="banner-title">
           <span class="decor-equal"></span>
		</div>
		<div  style="margin: 20px 0;">
                    <h3>Please enter the OTP Code sent to your email to proceed with your login</h3>
		</div>
	</div>
...
<div class="smallcontainer">
    <form action="../includes/security.inc.php" method="post" class="validate row" id="register">
       <div style="color: red"><?php if(isset($_GET["error"])) {if($_GET['error'] == "invalidcode") { echo "<h3 style='color: red'>Invalid otp code</h3>";} }?></div>
      
                        <div class="col-12 col-m-12 col-sm-12">
                            <input type="number" placeholder="Enter otp code" name="security" style="width:100%" style="width:100%" class="round" required>
        </div>
