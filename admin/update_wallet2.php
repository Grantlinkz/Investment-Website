         ...
         <div class="container-fluid mt-5">
            <div class="row">
                <div class="col-6 mx-auto">
                    <h5 class="bg-primary py-3 pl-5 text-center" style="color: #fff; margin-bottom: 0 !important">UPDATE ETHEREUM WALLET</h5>         
                    ...
                    <br><br><br>
                    <h3 class="text-center text-primary">Current Ethereum Wallet Address</h3>
                    ...
                    <?php
                        if(isset($_POST['update_btc'])) {
                            ...
                            $update_btc = "UPDATE eth_address SET wallet='$btc_address' WHERE id=1";
                            ...
                            if($show) {
                                ...
                                <div class='alert alert-success alert-dismissible  fade show col-md-8'>
                                        ...
                                        <strong> Ethererum Wallet Successfully updated</strong><a href ='admin_cpanel.php'> Click here to return to Cpanel</a>
                                 </div>
                            </center>";
