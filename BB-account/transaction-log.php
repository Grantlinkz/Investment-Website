<?php
    ...
    $sql2="select * from history1 where id='".$_SESSION['id']."' order by trans_id desc";
...
<div class="udex-main" id="main">
  ...
  <li class="bold">Transaction Activities</li></ul>
	<h4>Transaction Activities</h4>
	<span class="decor_default"></span>
</div>
<div class="white section round">
<h5>Transaction Activities</h5>
                    ...
                    <table class="table table-bordered table-hover">
                     ...
                     <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php 
                                $amount_no = $row2['amount'];
                                $account_no_show = number_format($amount_no, 2);
                            echo $account_no_show;  
                            ?></td>
