...
<title>Security | Swiftcotradefx</title>
...
<div class="udex-sidebar udex-collapse udex-animate-left" id="mySidebar">
	<ul class="udex-ul">
		...
		<li><a href="../includes/logout.inc.php"> <i class="fa fa-power-off"></i> Logout</a></li>
                <li><a href="../contact.php"> <i class="fa fa-exclamation-circle"></i> Help</a></li>
	</ul>
</div>
...
<div class="title_container">
  ...
  <li class="bold">Safety & Security</li></ul>
	<h4>Safety & Security</h4>
	<span class="decor_default"></span>
</div>
<div class="white section round">
	<h4>Change Password</h4>
	<p class="text-grey">If you notice any suspicious activity, we recommend changing your password.</p>
	<a href="changepass.php">Change password</a>
</div>
<div class="white section round">
<h4>Session History</h4>
<p class="text-grey">Information about the use of your account. Last activity: Thursday at 10:45 AM Linux premium171.web-hosting.com 2.6.32-954.3.5.lve1.4.80.el6.x86_64 #1 SMP Thu Sep 24 01:42:00 EDT 2020 x86_64(Browser Google Chrome)</p>
<div class="">
<h6>The last 10 visits show from which devices and when you logged in to the website. If you suspect that someone has access to your profile, please change the password.</h6>
<ul class="list"><li>Thursday, 07, July<br>
Browser: Google Chrome
<br>
IP: 156.146.59.22. Thursday at 10:45 AM
</li><li>Thursday, 07, July<br>
Browser: Google Chrome
<br>
IP: 156.146.59.22. Thursday at 06:52 AM
</li></ul>
