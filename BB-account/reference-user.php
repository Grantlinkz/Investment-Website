...
<title>Swiftcotradefx | Your Trusted Bitcoin  Mining Company</title>
...
<div id="account" class="udex-animate-right">
	<ul>
		...
		<li><a href="info.php"><i class="fa fa-user"></i> Daniel Efegoma</a></li>
...
<div class="udex-sidebar udex-collapse udex-animate-left" id="mySidebar">
	<ul class="udex-ul">
            ...
            <li class="active"><a href="transaction-log.php"> <i class="fa fa-crosshairs"></i> Account History</a></li>
...
<div class="udex-main" id="main">
  ...
  <li class="bold">Reference User</li></ul>
	<h4>Reference User</h4>
	<span class="decor_default"></span>
</div>
<div class="white section round row" style="padding:0;"><div class="col-12">
			<h5>Affilite Ranking System</h5>
			<h2>Your Affiliate Link: <span class="green" style="font-size: 14px; padding: 2px 5px; text-transform: lowercase; display: inline-block;">https://Swiftcotradefx.com/register/danielefegoma</span></h2>
			<p>Gain free promotion upgrade with each ascending affiliate rank, your rank is <strong>(1) starter</strong> accumulated <strong>7%</strong> in referral  investment! Your next rank will unlock with (5) successful referrals.</p>
		</div><div class="col-3 col-m-6 center">
			<div class="border padding default-hover-border">
				<div style="height:30px"><span class="default round-xxlarge" style="padding: 5px 10px; position: relative; top: -20px"><i class="fa fa-star"></i> Your Rank</span></div>
					<img src="../images/level1.png">
					<h5>7% bonus + $2</h5><hr>
					<div style="height: 100px">
						<p class="small">you will now gain $2 bonus for refference registration & 7% haspower with every new  investment</p>
					</div>
				</div>
			</div><div class="col-3 col-m-6 center">
			<div class="border padding default-hover-border">
				<div style="height:30px"><span class="grey round-xxlarge" style="padding: 5px 10px; position: relative; top: -20px"><i class="fa fa-share"></i> Next Rank</span></div>
					<img src="../images/level2.png" class="grayscale">
					<h5>9% bonus + $2</h5><hr>
					<div style="height: 100px">
						<p class="small">you will now gain 3.5% bouns haspower with every new sale</p>
					</div>
				</div>
			</div><div class="col-3 col-m-6 center">
			<div class="border padding default-hover-border">
				<div style="height:30px"></div>
					<img src="../images/level3.png" class="grayscale">
					<h5>11% bonus + $2</h5><hr>
					<div style="height: 100px">
						<p class="small">you will now gain 5.5% bouns haspower with every new sale</p>
					</div>
				</div>
			</div><div class="col-3 col-m-6 center">
			<div class="border padding default-hover-border">
				<div style="height:30px"></div>
					<img src="../images/level4.png" class="grayscale">
					<h5>15% bonus + $2</h5><hr>
					<div style="height: 100px">
						<p class="small">you will now gain 5.5% bouns haspower with every new sale</p>
					</div>
...
<div style="overflow-y: auto;" class="margint">
	<table style="width:100%" class="striped">
		<tr style="background: #F9F9FA; border-top: 1px solid #F1F1F1">
			<th>S/No</th><th style="min-width: 150px">Name</th><th style="min-width: 150px">User Email</th><th style="min-width: 100px">Username</th><th style="min-width: 100px">Created At</th><th style="min-width: 100px">Status</th>
		</tr><tr><td colspan="6"></td></tr>
	</table>
</div></div>	<div class="dash_footer">
