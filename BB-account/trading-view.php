...
<header class="cpanel_header row" id="cpanel_header" style="background-color:white">
	<ul>
		...
		<a href="../BB"><a href="../BB"><li class="brand"><img src="../BB/assets/images/logoIcon/logo.png" title="Swiftcotradefx | Your Trusted Bitcoin  Mining Company"/></li></a></a>
...
<div id="account" class="udex-animate-right">
	<ul>
		...
		<li><a href="info.php"><i class="fa fa-user"></i>Welcome, <?php echo $row['first_name'] ." " . $row['last_name']; ?></a></li>
...
<div class="udex-main" id="main">
  ...
  <li class="bold">Crypto Trading View</li></ul>
	<h4>Crypto Trading View</h4>
...
var cccTheme = {"General":{"borderWidth":"0px","borderColor":"#cccccc"},"Tabs":{"activeBorderColor":"#e75874"},"Chart":{"fillColor":"#cccccc","borderColor":"#e75874"}};
(function (){
