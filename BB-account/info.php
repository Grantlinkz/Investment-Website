...
<!--	<div class="center">
	<div id="imgArea" style="width:100px" class="circle">
		<img src="../images/avatar.png" style="width:100px" class="circle"><span></span>
		...
		<h2>Daniel Efegoma</h2>
	<button class="round white text-grey dashedbtn" id="myBtn">+ Upload a photo</button>
        </div>-->
<!--	<h6 class="text-grey center padding">Your photo will be displayed in direct messages, public chats and rankings.</h6><hr>-->
	<h6>Account Data</h6><hr>
	<div style="overflow-y: auto;">
	<table style="width:100%" class="striped">
        <tr><td><strong>First name</strong></td>
            <td style="text-transform: capitalize"><?php echo $row['first_name'] ?></td></tr>
        <tr><td><strong>Last name</strong></td>
        <td style="text-transform: capitalize"><?php echo $row['last_name'] ?></td></tr>
		<tr><td><strong>Gender</strong></td>
			<td style="text-transform: capitalize"><?php echo $row['sex'] ?></td></tr>
		<tr><td><strong>Country</strong></td>
			<td style="text-transform: capitalize"><?php echo $row['country'] ?></td></tr>
        <tr><td><strong>Email</strong></td>
        <td style="text-transform: capitalize"><?php echo $row['email'] ?></td></tr>
        <tr><td><strong>Mobile Phone</strong></td>
        <td style="text-transform: capitalize"><?php echo $row['phone_no'] ?></td></tr>
        <tr><td><strong>Account Type</strong></td>
        <td style="text-transform: capitalize"><?php echo $row['account_type'] ?></td></tr>
		</table></div></div>	<div class="dash_footer">
